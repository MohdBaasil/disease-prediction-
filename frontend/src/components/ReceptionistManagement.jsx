                ...
                {receptionists.map((rec) => (
                  <tr key={rec.id} className={`hover:bg-slate-50/70 dark:hover:bg-slate-800/20 transition-colors ${!rec.is_active ? 'opacity-60 bg-slate-50/40 dark:bg-slate-900/40' : ''}`}>
                    ...
                    <td className="py-3.5 px-3 text-center">
                      <span className={`px-2.5 py-0.5 rounded-full text-[10px] font-extrabold ${rec.is_active
                    ...
                    <td className="py-3.5 px-3 text-right">
                      <div className="flex items-center justify-end space-x-1.5">
                        ...
                        <button
                          ...
                          className={`p-1.5 rounded-lg border transition-colors ${rec.is_active
            ...
            <form onSubmit={handleSubmitForm} className="space-y-3">
              ...
              <div className="flex items-center justify-between pt-1">
                ...
                <button
                  ...
                  className={`w-9 h-5 rounded-full p-0.5 transition-colors relative inline-flex items-center ${formData.is_active ? 'bg-emerald-500' : 'bg-slate-300 dark:bg-slate-700'
                    }`}
                >
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-2xl max-w-sm w-full space-y-4 animate-scaleUp">
            ...
            <div className="flex justify-end space-x-2 pt-2 border-t border-slate-100 dark:border-slate-800">
              ...
              <button
                ...
                disabled={actionLoading}
                className={`px-5 py-2 text-white text-xs font-bold rounded-xl shadow flex items-center space-x-1.5 transition-colors ${targetStatusRec.is_active
